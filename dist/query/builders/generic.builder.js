...
var Generic = /** @class */ (function () {
    function Generic(_locale, _scrape) {
    ...
    Generic.prototype.parseIconURL = function (raw) {
        var str = raw
            .replace('[', '<')
            .replace(']', '>');
        return cheerio_1.default.load(str)('img').first().attr('src');
    };
    /** Parses an entity short url. */
    Generic.prototype.parseShortURL = function (raw) {
        return cheerio_1.default.load(raw)('a').attr('href');
    };
    /** Parses an entity name from an html raw string. */
    Generic.prototype.parseName = function (raw) {
        var str = cheerio_1.default.load(raw)
            .root()
            .text();
        return AppUtils.cleanStr(str);
    };
    Generic.prototype.build = function (data) {
        return [];
    };
    return Generic;
}());
